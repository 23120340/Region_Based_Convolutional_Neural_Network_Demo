...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Record full pen-assembly cycles for temporal action recognition")
    ...
    parser.add_argument("--scenario", choices=sorted(VALID_SCENARIOS), default="correct")
    ...
    session_dir = args.output / args.person / args.session
    session_dir.mkdir(parents=True, exist_ok=True)
    log_path = args.output.parent / "recording_log.csv"
    recording = False
    writer = None
